...
class CsvLogger:
    def __init__(self, setting_str: str, dataset_str: str,
                 model_str: str, output_dir: str, experiment_id: str, buffer_size: int) -> None:
        self.accs = []
    ...
    def write(self, args: Dict[str, Any]) -> None:
        ...
        write_headers = False
        path = os.path.join(results_dir, f"{self.setting}_{self.dataset}_{self.model}_{self.buffer_size}_mean_accs.csv")
